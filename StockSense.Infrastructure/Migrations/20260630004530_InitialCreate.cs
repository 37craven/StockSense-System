        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedProductsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedAddedCC = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreBuiltPackages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreBuiltPackagesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreBuiltPackageProduct", x => new { x.IncludedProductsId, x.PreBuiltPackagesId });
                    table.ForeignKey(
                        name: "FK_PreBuiltPackageProduct_PreBuiltPackages_PreBuiltPackagesId",
                        column: x => x.PreBuiltPackagesId,
                        principalTable: "PreBuiltPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PreBuiltPackageProduct_Products_IncludedProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreBuiltPackageProduct_PreBuiltPackagesId",
                table: "PreBuiltPackageProduct",
                column: "PreBuiltPackagesId");
